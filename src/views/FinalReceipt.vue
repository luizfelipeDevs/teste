                  ...
                  <div class="emb-card pb-12">
                     <div  id="payment-receipt">
                        ...
                        <div class="py-sm-12 py-8 px-sm-6 px-4">
                           ...
                           <div class="layout row wrap align-center d-flex my-0 text-md-left text-center" v-if="invoiceData.products" v-for="(cart, index) in invoiceData.products" :key="index">
